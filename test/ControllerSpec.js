...
//Справка о брачной правоспособности 
	...
	it('should highlight "Active" filter when switching to active view', function () {//not sure yet
		// TODO: write test 
		var todo = {id: 42, title: 'my todo'};
		//todoCounts:'active'
		setUpModel([todo]);
	...
	describe('toggle all', function () {
		...
		view.trigger('toggleAll', {id: 21, completed: true});
	...
	describe('element removal', function () {
		it('should remove an entry from the model', function () {
			...
			subject.setView('');
			view.trigger('itemRemove', {id: 42});// check trigger
